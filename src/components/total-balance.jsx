  ...
  return (
    <div className="flex justify-between">
      ...
      <div onClick={handleSettingsRedirect}>
        <Button 
          size="sm" 
          className="rounded-lg cursor-pointer bg-primary border dark:border-gray-600  dark:bg-[#101010] dark:hover:bg-gray-600"
        >
          <Settings size={30} className="dark:text-gray-200" />
        </Button>
      </div>
    </div>
  )
