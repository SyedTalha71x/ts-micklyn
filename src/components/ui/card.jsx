...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-xl shadow-lg py-6",
        className
      )}
      {...props} />
  );
...
export { Card, CardHeader, CardFooter, CardTitle, CardDescription, CardContent, Card1 }
