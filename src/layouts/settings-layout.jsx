        ...
        <div className="p-6 flex items-center justify-between">
          {isMobile && showContent ? (
            ...
            <div className="flex justify-between items-center w-full px-4 py-2">
              ...
              {/* Right Side: Button */}
              <button onClick={() => navigate('/chat')} className="hover:cursor-pointer hover:bg-black/70  text-sm md:text-base px-4 py-2 bg-black text-white dark:bg-[#202229] dark:text-white rounded-lg">
                Back to Chat
              </button>
            </div>
          )}
