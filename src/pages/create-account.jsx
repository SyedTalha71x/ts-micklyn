        ...
        <div className="w-full max-w-md">
          ...
          <div className="space-y-4 mt-4">
            <form className="space-y-4">
              <Input
                ...
                className="text-sm border border-[#687588]"
              />
            ...
            <Button variant="outline" className="w-full text-sm h-10 border border-[#687588]">
              <svg
          ...
          <div className="flex manrope-font-500 justify-center py-4">
            <p className="text-md text-muted-foreground">
              ...
              <a
                href="#"
                className="manrope-font-500 text-foreground"
              >
                Login!
              </a>
            </p>
